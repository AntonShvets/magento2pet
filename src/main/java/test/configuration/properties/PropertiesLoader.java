...
import test.exceptions.TestsConfigurationException;
...
public class PropertiesLoader {
     ...
     *
     * @param config {@link BrowserConfig} object
     */
    public static void populate(BrowserConfig config) {
     ...
     * Sets TestConfig object fields values to specified properties values
     *
     * @param config {@link test.configuration.UrlConfig} object
     */
    public static void populateUrl(UrlConfig config) {
        Properties properties = null;
        PropertyFile propertyFileAnnotation = config.getClass().getAnnotation(PropertyFile.class);
        if (propertyFileAnnotation != null) {
            String propertyFileName = propertyFileAnnotation.value();
